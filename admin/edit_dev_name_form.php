<div class="row-fluid">				  
   <a href="dev_name.php" class="btn btn-info" id="add" data-placement="right" title="Click to Add Client" ><i class="icon-plus-sign icon-large"></i> Tambah Tipe Barang</a>
	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-pencil icon-large"></i> Edit Tipe Barang</div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form method="post">
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" value="<?php echo $row['dev_name']; ?>" name="dev_name" id="focusedInput" type="text" placeholder = "Tipe Barang" required>
                                          </div>
                                        </div>
...
<script>
 ...
 $.jGrowl("Tipe Barang Berhasil di Update", { header: 'Tipe Barang Update' });  
</script>
<?php
}
?>