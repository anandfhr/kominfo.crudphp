		                        ...
		                        <div id="" class="block">
									...
									?>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" value="<?php echo $row['dev_harga']; ?>" name="dev_harga" id="inputPassword" placeholder="Harga Perolehan" required>
											</div>
										</div>
