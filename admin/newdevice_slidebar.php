     <div class="span3" id="sidebar">
				   ...
				   <img id="admin_avatar" class="img-polaroid" src="<?php echo $row['adminthumbnails']; ?>"> </div>
                    ...
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
					    ...
					    <li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs1"><i class="icon-chevron-right"></i><i class="icon-sitemap"></i>&nbsp;Kelola Lokasi
							<div class="muted pull-right"><i class="caret"></i></div></a>						
