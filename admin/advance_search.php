        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="span9" id="content">
					 ...
					 <h2 id="sc" align="center"><image src="" width="45%" height="45%"/></h2>
					 <?php	
...
<?php
		...
		LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
		where dev_name LIKE '%$dev_name%' 
		and stdev_location_name LIKE '%$stdev_location_name%'")or die(mysql_error());
