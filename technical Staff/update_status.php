		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
								    ...
								    <div class="container-fluid">
                                     <div class="row-fluid">
			 					     <div class="">
                                     <strong>Catatan!</strong> Perbarui Status Barang tidak ditampilkan di daftar Barang baru.
                                     </div>
									 </div>
									 </div>
									   ...
									   <div class="control-group">
										...
										<div id="hide">
										 <div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" value="<?php echo $row['dev_serial']; ?>" name="dev_serial" placeholder="Kode Barang" >
											</div>
										</div>	
										</div>
											
										<div class="control-group">
											<label class="control-label" for="inputPassword"  placeholder="Kondisi Barang" >Kondisi Barang</label>
											<div class="controls">
										...
										$.jGrowl("Kondisi Barang Berhasil di Update", { header: 'Kondisi Barang Update' });
										</script>
										<?php
										}
