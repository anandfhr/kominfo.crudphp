   <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"> <i class="icon-plus-sign icon-large"> Tambah Lokasi</i></div>
                            </div>
...
mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Tambah Lokasi $stdev_location_name')")or die(mysql_error());
?>
<script>
